...
function getIntensityForDMX($dmx) {
...
function getIntensityForChannel($channel) {
...
function getOverallIntensityForDMX($dmx) {
...
function setIntensityForDMX($dmx, $newIntensity) {
...
function setIntensityForChannel($channel, $newIntensity) {
...
function deleteDMXAssignment($dmx) {
...
function resetChannelIntensities() {
